...
$factory->define(Activity::class, function (Faker $faker) {
    ...
    return [
    	...
    	'startDate' => $faker->dateTimeBetween($startDate = 'now', $endDate = '+2 weeks', $timezone = null)->format('d-m-Y'),
    	'endDate' => $faker->dateTimeBetween($startDate = '+2 weeks', $endDate = '+4 weeks', $timezone = null)->format('d-m-Y'),
    	'name' => str_random(30),
